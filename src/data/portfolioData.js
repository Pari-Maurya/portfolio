...
export const projectsData = [
  {
    ...
    github: "https://github.com/parimaurya/careercraft",
    demo: "https://careercraft-demo.vercel.app",
  ...
  },
  {
    id: "resolveiq",
    name: "ResolveIQ",
    subtitle: "SaaS Refund & Payment Workflow Platform",
    category: "SaaS & Tools",
    description:
      "A SaaS-style platform designed to streamline refund processing, automated notifications, and payment-related merchant workflows.",
    longDescription:
      "ResolveIQ resolves common friction in e-commerce refund workflows by automating claim validations, merchant approvals, and Razorpay payment dispatches with real-time audit logging.",
    tech: ["React", "Node.js", "Express", "MongoDB", "Razorpay API", "Tailwind CSS"],
    features: [
      "Razorpay payment gate integration",
      "Automated merchant refund dispatch engine",
      "Transaction audit logs & status tracking",
      "MongoDB database for dispute history",
      "Customer email receipt notifications",
    ],
    github: "https://github.com/parimaurya/resolve-iq",
    demo: "https://resolveiq.vercel.app",
    badge: "SaaS Platform",
  ...
  },
  {
    ...
    github: "https://github.com/parimaurya/weather-app",
    demo: "https://pari-weather.vercel.app",
    badge: "API Showcase",
